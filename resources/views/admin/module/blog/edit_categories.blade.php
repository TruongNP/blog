        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header d-flex align-items-center py-3 mb-3">
              <h6 class=" m-0"><a href={{ route('blog.categories') }} class="border-right border-primary text-decoration-none font-weight-bold text-primary text-capitalize pr-2 m-0">View all</a></h6>
