...
function AddPage() {
    ...
    const submitForm = () => {
        ...
        axios.post('/api/v1/discounts', data, {
    ...
    return (
        <main className="main">
            <div className="container pt-5 pl-5 pb-5 pr-5">
                <h1 className="h3 mb-2 text-gray-800">{t('module.discounts.page_add_label')}</h1>
                ...
                <div className="row mt-4">
                    <div className="col-8">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <div className="input-group mb-3">
                                    ...
                                    <NumberFormat onChange={(e) => {onChangProductPrice(e)}} className={`form-control ${errors.product_price ? 'is-invalid' : ''}`} thousandSeparator={true} />
                            ...
                            <div className="form-group">
                                <label htmlFor="slt-collection-status">{t('module.discounts.status')}</label>
                                <select
                        ...
                        <button className="btn btn-primary bg-primary mt-3" onClick={() => {submitForm()}}>{t('general.save')} {submiting == true ? <Loader with="20" /> : null}</button>
                    </div>
                </div>
            </div>
        </main>
